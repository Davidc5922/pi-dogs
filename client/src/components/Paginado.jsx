...
return (
  <div className='paginado'>
    <button onClick={()=>{previous()}} className="buton">
        <svg viewBox="0 0 20 27" fill="none" xmlns="http://www.w3.org/2000/svg" className='button_img'>
          <path
    ...
    <input name='page' type='text' value={input} onChange={e=>{handleonChange(e)}} onKeyDown={e=>{onKeyDown(e)}} className="num_pag" autoComplete='off'/>


    <p className='Num_paginas'>de {maximo}</p>

    
    <button onClick={()=>{nexPage()}} className="buton"><svg
          width="20"
          height="27"
          viewBox="0 0 20 27"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className='button_img2'
        >
          <path
